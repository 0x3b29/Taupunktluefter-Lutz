...
#define SIGNAL_ON_PIN 9 // D6 on NANO = PIN 9
#define SIGNAL_OFF_PIN 10 // D6 on NANO = PIN 9

void generateOffSignal() {
  digitalWrite(SIGNAL_OFF_PIN, HIGH);
  delay(500);
  digitalWrite(SIGNAL_OFF_PIN, LOW);
}

void generateOnSignal() {
  digitalWrite(SIGNAL_ON_PIN, HIGH);
  delay(500);
  digitalWrite(SIGNAL_ON_PIN, LOW);
}
...
void setup()
{
  ...
  pinMode(SIGNAL_ON_PIN, OUTPUT);
  pinMode(SIGNAL_OFF_PIN, OUTPUT);
  generateOffSignal();
